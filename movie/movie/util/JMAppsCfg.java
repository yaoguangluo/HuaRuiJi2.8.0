...
public class JMAppsCfg {
    ...
    public static final String  KEY_JMthisInterfaceDIO_FRAME_POS = "Location of JMthisInterfacedio Frame";
    ...
    private static final String         signatureFileCfg = "JMthisInterfacedio configuration data file.";
    ...
    @SuppressWarnings("rawtypes")
	public Point getJMthisInterfacedioFrameLocation ( int nFrameIndex ) {
        int     nCount;
        int     nIndex;
        Object  objValue;
        ...
        objValue = hashProperties.get ( KEY_JMthisInterfaceDIO_FRAME_POS );
        if ( objValue != null  &&  objValue instanceof Vector ) {
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
	public void setJMthisInterfacedioFrameLocation ( Point pointValue, int nFrameIndex ) {
        int     nCount;
        Object  objValue;
        Vector  vectorValues = null;
        ...
        if ( objValue != null  &&  objValue instanceof Vector ) {
            ...
            hashProperties.put ( KEY_JMthisInterfaceDIO_FRAME_POS, vectorValues );
        }
	...
	private void readFile () {
        ...
        try {
            ...
            MessageDialog.createErrorDialog ( null,
                                JMFI18N.getResource("jmthisInterfacedio.error.cfgfile.read"),
                                exception );
        }
        ...
        try {
            ...
            MessageDialog.createErrorDialog ( null,
                                JMFI18N.getResource("jmthisInterfacedio.error.cfgfile.close"),
                                exception );
        }
    }
...
//            MessageDialog.createErrorDialog ( null,
//                                JMFI18N.getResource("jmthisInterfacedio.error.cfgfile.create"),
//                                exception );
            System.out.println ( JMFI18N.getResource("jmthisInterfacedio.error.cfgfile.create")
        ...
        try {
            ...
            MessageDialog.createErrorDialog ( null,
                                JMFI18N.getResource("jmthisInterfacedio.error.cfgfile.write"),
                                exception );
        }
