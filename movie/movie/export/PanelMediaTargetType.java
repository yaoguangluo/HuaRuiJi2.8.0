...
public class PanelMediaTargetType extends JMPanel {
    ...
    public static final String		TYPE_FILE = JMFI18N.getResource("jmthisInterfacedio.export.type.file");
    public static final String		TYPE_NETWORK = JMFI18N.getResource("jmthisInterfacedio.export.type.network");
    public static final String		TYPE_SCREEN = JMFI18N.getResource("jmthisInterfacedio.export.type.screen");
    public static final String		TYPE_OTHER = JMFI18N.getResource("jmthisInterfacedio.export.type.other");
	...
	private void init () throws Exception {
    	...
    	panelDescription.add ( new Label(JMFI18N.getResource("jmthisInterfacedio.export.type.label1")) );
    	panelDescription.add ( new Label(JMFI18N.getResource("jmthisInterfacedio.export.type.label2")) );
