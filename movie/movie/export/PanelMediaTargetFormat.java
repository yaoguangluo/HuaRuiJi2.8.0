...
//        Toolkit    toolkit;
    	...
    	panelDescription.add ( new Label(JMFI18N.getResource("jmthisInterfacedio.export.format.label1")) );
    	panelDescription.add ( new Label(JMFI18N.getResource("jmthisInterfacedio.export.format.label2")) );
	...
	private void buildPage () {
        ...
        label = new Label ( JMFI18N.getResource("jmthisInterfacedio.export.format.format") );
...
//        Panel               panel;
        ...
        String              strTitle;
        String              strEncoding;
        String              strAudio = JMFI18N.getResource("jmthisInterfacedio.export.format.audio");
        String              strVideo = JMFI18N.getResource("jmthisInterfacedio.export.format.video");
        String              strHinted = JMFI18N.getResource("jmthisInterfacedio.export.format.hinted");
