...
//import jmapps.ui.*;
//import movie.util.*;
//import jmapps.jmthisInterfacedio.*;
...
class TransmitPlayerWindow extends PlayerWindow implements ActionListener, WindowListener {
    ...
    private static final String MENU_STATS              = JMFI18N.getResource ( "jmthisInterfacedio.menu.stats" );
    private static final String MENU_STATS_TRANSMISSION = JMFI18N.getResource ( "jmthisInterfacedio.menu.player.transmission" );


    public TransmitPlayerWindow ( Processor processor ) {
        super ( processor, JMFI18N.getResource("jmthisInterfacedio.playerwindow.transcoding"), true );
