...
public class PanelMediaTargetFile extends JMPanel implements ActionListener {
	...
	private void init () throws Exception {
    	...
    	panelDescription.add ( new Label(JMFI18N.getResource("jmthisInterfacedio.export.targetfile.label1")) );
    	panelDescription.add ( new Label(JMFI18N.getResource("jmthisInterfacedio.export.targetfile.label2")) );
    	...
    	buttonBrowse = new Button ( JMFI18N.getResource("jmthisInterfacedio.export.targetfile.browse") );
	...
	private void browseFile () {
    	...
    	dlgFile = new FileDialog ( getFrame(),
                        JMFI18N.getResource("jmthisInterfacedio.export.targetfile.filedialog"),
                        FileDialog.SAVE );
