...
public class ViewReportBlock extends JMPanel {
    ...
    private static final String LABEL_DLSR          = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.feedback.dlsr" );
    private static final String LABEL_FRACTION_LOST = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.feedback.fractionlost" );
    private static final String LABEL_LOST_PACKETS  = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.feedback.lostpackets" );
    private static final String LABEL_JITTER        = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.feedback.jitter" );
    private static final String LABEL_LSR           = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.feedback.lsr" );
    private static final String LABEL_SSRC          = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.feedback.ssrc" );
    private static final String LABEL_XTNDSEQNUM    = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.feedback.xtndseqnum" );
