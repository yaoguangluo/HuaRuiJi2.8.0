...
public class PanelParticipants extends JMPanel implements ComponentListener,
    ...
    public static final String  PARTICIPANTS            = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.partcipants" );
    public static final String  REMOTE_RECEIVE_STREAM   = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.partcipants.remotereceivestream" );
    public static final String  UNKNOWN_STREAM          = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.partcipants.unknownstream" );
    public static final String  REPORT                  = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.partcipants.report" );
    public static final String  LATEST_SENDER_REPORT    = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.partcipants.latestsenderreport" );
    public static final String  REPORT_BLOCK            = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.partcipants.reportblock" );
    public static final String  REPORT_BLOCK_BY_ME      = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.partcipants.reportblockbyme" );
    public static final String  SENDER_REPORT_BLOCK     = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.partcipants.senderreportblock" );
