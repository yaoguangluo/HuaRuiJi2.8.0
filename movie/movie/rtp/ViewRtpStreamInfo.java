...
public class ViewRtpStreamInfo extends JMPanel {
    ...
    private static final String LABEL_NAME              = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.stream.owner" );
    private static final String LABEL_SSRC              = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.stream.ssrc" );
    private static final String LABEL_LOST_PDU          = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.stream.lostpdu" );
    private static final String LABEL_PROCESSED_PDU     = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.stream.processedpdu" );
    private static final String LABEL_MISORDERED_PDU    = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.stream.misorderedpdu" );
    private static final String LABEL_INVALID_PDU       = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.stream.invalidpdu" );
    private static final String LABEL_DUPLICATE_PDU     = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.stream.duplicatepdu" );
