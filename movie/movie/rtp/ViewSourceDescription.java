...
public class ViewSourceDescription extends JMPanel {
    ...
    private static final String LABEL_CNAME     = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.srcdescr.cname" );
    private static final String LABEL_NAME      = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.srcdescr.name" );
    private static final String LABEL_EMAIL     = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.srcdescr.email" );
    private static final String LABEL_PHONE     = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.srcdescr.phone" );
    private static final String LABEL_LOCATION  = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.srcdescr.location" );
    private static final String LABEL_TOOL      = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.srcdescr.tool" );
    private static final String LABEL_NOTE      = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.srcdescr.note" );
    private static final String LABEL_PRIVATE   = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.srcdescr.private" );
    private static final String LABEL_NONE      = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.srcdescr.none" );
