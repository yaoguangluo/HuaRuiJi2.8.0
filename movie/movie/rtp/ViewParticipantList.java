...
public class ViewParticipantList extends JMPanel {
    ...
    public static final String  NONE            = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.partcipants.none" );
    public static final String  REMOTE          = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.partcipants.remote" );
    public static final String  LOCAL           = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.partcipants.local" );
    public static final String  PASSIVE         = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.partcipants.passive" );
    public static final String  ACTIVE          = JMFI18N.getResource ( "jmthisInterfacedio.rtpsessionctrl.partcipants.active" );
