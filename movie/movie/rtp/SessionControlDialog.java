...
public class SessionControlDialog extends JMDialog {
	...
	public SessionControlDialog ( Frame frame, SessionManager mngrSession ) {
	    super ( frame, JMFI18N.getResource("jmthisInterfacedio.rtpsessionctrl.title"), false );
    ...
    private void init () throws Exception {
        ...
        tabControl.addPage ( panel, JMFI18N.getResource("jmthisInterfacedio.rtpsessionctrl.panel.overall") );
        panel = createParticipantsPanel ();
        tabControl.addPage ( panel, JMFI18N.getResource("jmthisInterfacedio.rtpsessionctrl.panel.participants") );
        panel = createBufferControlPanel ();
        tabControl.addPage ( panel, JMFI18N.getResource("jmthisInterfacedio.rtpsessionctrl.panel.bufferctrl") );
