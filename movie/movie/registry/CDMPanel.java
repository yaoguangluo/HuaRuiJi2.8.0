...
public class CDMPanel extends JMPanel implements VectorEditor, ActionListener {
	...
	if (autoVideo == null) {
        ...
        popupWait = new PopupWait ( getFrame(),
                        JMFI18N.getResource("jmthisInterfacedio.mssg.capturequery")
                        + "\n" + JMFI18N.getResource("jmfregistry.appname") + " "
                        + JMFI18N.getResource("jmthisInterfacedio.mssg.lookingcapture") );
        ...
        try {
            ...
            MessageDialog.createErrorDialog ( new Frame(), JMFI18N.getResource("jmthisInterfacedio.error.capturequery") );
        }
