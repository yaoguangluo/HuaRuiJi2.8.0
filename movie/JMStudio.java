...
//            setPlaceholder ();
    ...
    public void open ( String nameUrl ) {
        ...
        mediaPlayer = movie.util.JMFUtils.createMediaPlayer ( nameUrl, (Frame)this, audioEffect, videoEffect );
...
//            setPlaceholder();
        ...
        mediaPlayer = movie.util.JMFUtils.createMediaPlayer ( processorTransmit, (Frame)this );
