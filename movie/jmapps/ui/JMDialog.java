...
public class JMDialog extends Dialog  implements ActionListener, WindowListener {
    ...
    public static final String     ACTION_OK = JMFI18N.getResource ( "jmthisInterfacedio.dlg.ok" );
    public static final String     ACTION_CANCEL = JMFI18N.getResource ( "jmthisInterfacedio.dlg.cancel" );
    public static final String     ACTION_CLOSE = JMFI18N.getResource ( "jmthisInterfacedio.dlg.close" );
    public static final String     ACTION_OPEN = JMFI18N.getResource ( "jmthisInterfacedio.dlg.open" );
    public static final String     ACTION_SAVE = JMFI18N.getResource ( "jmthisInterfacedio.dlg.save" );
    public static final String     ACTION_YES = JMFI18N.getResource ( "jmthisInterfacedio.dlg.yes" );
    public static final String     ACTION_NO = JMFI18N.getResource ( "jmthisInterfacedio.dlg.no" );
