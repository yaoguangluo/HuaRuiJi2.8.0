...
public class WizardDialog extends JMDialog /*implements WindowListener, ActionListener*/ {
    ...
    public static final String		ACTION_FINISH = JMFI18N.getResource("jmthisInterfacedio.wizard.finish");
    public static final String		ACTION_CANCEL = JMFI18N.getResource("jmthisInterfacedio.wizard.cancel");
    public static final String		ACTION_NEXT = JMFI18N.getResource("jmthisInterfacedio.wizard.next");
    public static final String		ACTION_BACK = JMFI18N.getResource("jmthisInterfacedio.wizard.back");
