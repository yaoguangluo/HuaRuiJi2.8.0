...
public class ProgressDialog extends JMDialog {
    ...
    public static final String    ACTION_ABORT = JMFI18N.getResource("jmthisInterfacedio.saveprogress.abort");
    public static final String    ACTION_STOP  = JMFI18N.getResource("jmthisInterfacedio.saveprogress.stop");
    public static final String    ACTION_PAUSE = JMFI18N.getResource("jmthisInterfacedio.saveprogress.pause");
    public static final String    ACTION_RESUME = JMFI18N.getResource("jmthisInterfacedio.saveprogress.resume");
    ...
    public void setCurPos ( int nPos ) {
        if ( progressBar != null ) {
            ...
            labelProgress.setText ( JMFI18N.getResource("jmthisInterfacedio.saveprogress.saved")
                                + " " + nPos + " "
                                + JMFI18N.getResource("jmthisInterfacedio.saveprogress.seconds") + "...");
        }
    }
