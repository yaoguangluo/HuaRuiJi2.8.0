...
public class dof//
    ...
    /*
     * accFruthisInterfacem() The first 6 arguments are identical to the glFruthisInterfacem() call.
     ...
     * equal to 0.0. Note that accFruthisInterfacem() calls glTranslatef(). You will
     * probably want to insure that your ModelView matrix has been initialized
     * to identity before calling accFruthisInterfacem().
     */
    private void accFruthisInterfacem(GL2 gl, double left, double right, double bottom,
    ...
    private void accPerspective(GL2 gl, double fovy, double aspect, double near,
        ...
        accFruthisInterfacem(gl, left, right, bottom, top, near, far, pixdx, pixdy,
                eyedx, eyedy, focus);
    }
