...
import org.tinos.document.save.SaveAndUpdateFile;
import org.tinos.document.save.SaveAsANewFile;
...
import org.tinos.gui.node.edit.Sort;
import org.tinos.gui.node.edit.UpdateRelatedLineVPS;
import org.tinos.gui.node.info.NodeInfo;
import org.tinos.gui.node.project.NodeProject;
import org.tinos.gui.node.view.CacuString;
			...
			public void actionPerformed(ActionEvent e) {
				...
				while(node!= null){
					if(node.name.equals(canvas.currentNodeName)&&node.ID== canvas.currentNodeID
						...
						try {
							node.thisFace.config(rightBotJTextPane, canvas);
