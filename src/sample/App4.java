...
//public class App4 extends JApplet implements MouseListener, KeyListener, ActionListener{	
...
//	public Map<String, Object> dic_yw;
...
//					appSearch.show();
//					JFrame frame= new JFrame("电子护理站 V1.0.0");
...
//								page.append("<span style=\"background:"+new imageProcessor.ColorProcessor().Processor(255, 245, 255)+"\"><font color=\"black\" size=\"5\">" + setOfi +(posFullce.containsKey(setOfi)?":("+posFullce.get(setOfi)+")":"") + "</font></span>");
//								continue Here;
//							}
