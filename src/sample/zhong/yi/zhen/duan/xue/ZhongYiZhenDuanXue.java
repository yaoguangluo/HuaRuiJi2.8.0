...
public class ZhongYiZhenDuanXue extends Container implements MouseListener, KeyListener{
	...
	public ZhongYiZhenDuanXue(JTextPane text,Analyzer analyzer, Map<String, String> pos, Map<String, String> pose
