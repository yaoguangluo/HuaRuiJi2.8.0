...
public class XiYiYaoXue extends Container implements MouseListener, KeyListener{
	...
	public XiYiYaoXue(JTextPane text, Analyzer analyzer, Map<String, String> pos
