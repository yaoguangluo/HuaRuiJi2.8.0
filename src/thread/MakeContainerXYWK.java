...
public class MakeContainerXYWK extends Thread implements Runnable{
	...
	public MakeContainerXYWK(Analyzer analyzer, App3 u2, JTabbedPane jTabbedpane, String[] tabNames,Map<String, String> pos, Map<String, String> pose, Map<String, String> etc, Map<String, String> cte) {
		super();
		this.u = u2;
