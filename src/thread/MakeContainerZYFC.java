...
public class MakeContainerZYFC extends Thread implements Runnable{
	...
	public MakeContainerZYFC(Analyzer analyzer,AppBoot u2, JTabbedPane jTabbedpane, String[] tabNames
	...
	public void run(){ 
		try {
			...
			jTabbedpane.addTab(tabNames[9],new ImageIcon() , u.jpanel10, "傅青主妇科");// 加入第一个页面  
			jTabbedpane.validate();
		} catch (IOException e) {
			jTabbedpane.validate();
